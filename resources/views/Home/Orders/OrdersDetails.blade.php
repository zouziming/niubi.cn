		...
		<section class="user-center inner clearfix">
			<div class="pull-left bgf">
				...
				<dl class="user-center__nav">
					...
					<a href="javascript:void(0)"><dd>数据自助下载</dd></a>
				...
				<dl class="user-center__nav">
					<dt>新手上路</dt>
					<a href="javascript:void(0)"><dd>如何成为代理商</dd></a>
					<a href="javascript:void(0)"><dd>代销商上架教程</dd></a>
					<a href="javascript:void(0)"><dd>分销商常见问题</dd></a>
					<a href="javascript:void(0)"><dd>付款账户</dd></a>
				</dl>
				<dl class="user-center__nav">
					<dt>U袋网</dt>
					<a href="javascript:void(0)"><dd>企业简介</dd></a>
					<a href="javascript:void(0)"><dd>加入U袋</dd></a>
					<a href="javascript:void(0)"><dd>隐私说明</dd></a>
				</dl>
			</div>
			<div class="pull-right">

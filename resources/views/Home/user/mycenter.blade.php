...
<div class="user-info">
    ...
    <div class="user-infoPic" style="border-bottom:0px">
        ...
        <img class="am-circle am-img-thumbnail" src="/storage/{{ session('userInfo.pic') }}" style="border:1px solid #00CCFF" />
        @else
        <img class="am-circle am-img-thumbnail" style="border:1px solid #00CCFF" src="/lib/img/do.jpg" alt="" />
        @endif
        </div>
        ...
        <a href="/home/user/password?id={{ session('userInfo.id') }}">修改密码</a>
        <!-- <div class="vip">
    ...
    @endif
    <form class="am-form am-form-horizontal" action="/home/user/mycenter" method="post">
        {{ csrf_field() }}
        <input type="hidden" name="id" value="{{ session('userInfo.id') }}">
        <div class="am-form-group">
            <label for="user-name2" class="am-form-label">用户名</label>
            <div class="am-form-content">
            <input type="text" id="user-name2" name="username" placeholder="{{ session('userInfo.username') }}" style="border:1px solid #00CCFF;height:28px">
            </div>
        </div>
        <div class="am-form-group">
        ...
        <div class="am-form-group">
            ...
            <div class="am-form-content">
            <input id="user-phone" name="phone" placeholder="{{ session('userInfo.phone') }}" type="tel" style="border:1px solid #00CCFF;height:28px">
            </div>
        </div>
        <div class="am-form-group">
            <label for="user-email" class="am-form-label">电子邮件</label>
            <div class="am-form-content">
            <input id="user-email" name="email" placeholder="{{ session('userInfo.email') }}" type="email" style="border:1px solid #00CCFF;height:28px">
            </div>
        </div>
        <div class="am-form-group">
            <label for="user-email" class="am-form-label">注册时间</label>
            <div class="am-form-content">
            <input id="user-email" placeholder="{{ session('userInfo.addtime') }}" type="text" readonly style="border:1px solid #00CCFF;height:28px">
            </div>
        </div>
        <div class="info-btn">
            <div class="am-btn am-btn-danger"><button style="border:0px;background:#dd514c;height:28px;width:81px">保存修改</button></div>
        </div>
    </form>     
    </div>
</div>

...
<div class="div_from_aoto" style="width: 500px;">
    ...
    <form action="/admin/editpwd" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input_from" placeholder=" 原密码" name="oldPassword" type="password" value="" required>
            <p class="help-block"></p>
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
            <input class="input_from" type="password" placeholder=" 新密码" name="newpassword" value="" required>
            <p class="help-block"></p>
            </div>
        </div>
        <div class="control-group">

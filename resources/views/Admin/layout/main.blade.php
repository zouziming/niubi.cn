        ...
        <ul class="tendina" id="menu">
            ...
            <li class="childUlLi">
                ...
                <ul style="display: none;">
            		...
            		<li><a href="/admin/goods/attr"><i class="glyph-icon icon-chevron-right"></i>规格名称列表</a></li>
            		<li><a href="/admin/allattr"><i class="glyph-icon icon-chevron-right"></i>规格值列表</a></li>

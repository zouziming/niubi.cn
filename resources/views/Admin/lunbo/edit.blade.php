...
<div class="wrap">
    ...
    <form action="/admin/lunbo/edit" method="post" enctype="multipart/form-data">
		<input type="hidden" name="id" value="{{$data['id']}}">
		{{ csrf_field() }}
        <table class="list-style">
            <tr>
                <td style="text-align:right;">更换图片：</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <img src="{{$data['pic']}}" width="260"  class="mlr5" />
				</td>
			</tr>
            ...
            <tr>
                ...
                <td>
                    <input type="submit" value="修改" class="tdBtn" /></td>
            </tr>
        </table>
    </form>
</div>
